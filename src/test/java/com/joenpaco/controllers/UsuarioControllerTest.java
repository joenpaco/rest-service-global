...
class UsuarioControllerTest {
	...
	void testAddNewUsuario() {
		...
		// 2.- Act
		ResponseEntity<UsuarioDto> usuario = usuarioService.addNewUsuario(usuarioFalso);
	...
	void testUpdate() {
		...
		// 2.- Act
		ResponseEntity<UsuarioDto> usuario = usuarioService.updateUsuario(usuarioFalso);
...
//		Usuario usuarioFalso;
		...
		// 2.- Act
		ResponseEntity<UsuarioDto> usuario = usuarioService.deleteById(usuarioFalso);
